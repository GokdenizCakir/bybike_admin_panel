...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } z-50 absolute shadow-[0_5px_10px_0px_rgba(0,0,0,0.12)] md:sticky bg-white md:translate-x-0 md:w-80 flex flex-col items-center h-screen transition-all min-w-80 p-4`}
    >
      <div
